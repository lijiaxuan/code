...
* @Last Modified time: 2016-03-10 14:50:18
*/
...
void num_show(unsigned char pos)
{
    ...
    LCD_ShowString(180, 180 , "         ", WHITE,1);
    LCD_ShowString(180, 180 , num.numstr, WHITE,1);
...
void int2str()
{
    ...
    for(k = 9;tmp != 0 && k >= 0; tmp = tmp / 10,k --)
...
void str2float()
{
    ...
    signed short s = 1;
      ...
      {s = s * 10;}
		...
		num.str2int();
    num.floatvalue = num.intvalue / (float)(s);
