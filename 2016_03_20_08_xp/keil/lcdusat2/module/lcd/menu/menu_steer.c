...
* @Last Modified time: 2016-03-12 11:04:23
*/
...
struct Item steer_i[] = 
{
    ...
    {"upperlimit",      3,  9,    FILE,   1,   0,  &steer.limit[0],  0,   menu_nop, menu_set_upperlimit_exec,  menu_set_upperlimit_input,menu_set_upperlimit_back},
    {"lowerlimit",      4,  9,    FILE,   1,   0,  &steer.limit[1],  0,   menu_nop, menu_set_lowerlimit_exec,  menu_set_lowerlimit_input,menu_set_lowerlimit_back},
...
static unsigned short ccr;
static void menu_steer_init(void *parg)
{
    steer_n.p_item[0].p_short = &ccr;
