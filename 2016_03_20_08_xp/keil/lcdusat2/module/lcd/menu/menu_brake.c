...
* @Last Modified time: 2016-03-12 10:53:09
*/
...
struct Item brake_i[] = 
{
    ...
    {"status",          4,  6,    FILE,   1,   0,  (unsigned short *)&brake.status,  0,   menu_nop, menu_set_upperlimit_exec,  menu_set_upperlimit_input,menu_set_upperlimit_back},
