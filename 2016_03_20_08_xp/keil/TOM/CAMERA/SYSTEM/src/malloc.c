...
__align(4) u8 mem2base[MEM2_MAX_SIZE] __attribute__((at(0X6804b000)));					//外部SRAM内存池 start at 0x68000000+153600*2(GUI Buffer) 
//内存管理表
u16 mem1mapbase[MEM1_ALLOC_TABLE_SIZE];													//内部SRAM内存池MAP
u16 mem2mapbase[MEM2_ALLOC_TABLE_SIZE] __attribute__((at(0X6804b000+MEM2_MAX_SIZE)));	//外部SRAM内存池MAP
//内存管理参数	   
