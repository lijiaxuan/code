...
#ifdef	FIRST
fp64  Gyro_Convert1=1.5924000957;    //????????
fp64  Gyro_Convert2=1.5928435161;    //????????
fp64  Gyro_Convert= (1.5924000957+1.5928435161)/2;
#endif

#ifdef SECOND
  fp64  Gyro_Convert1=1.5816213855;    //第二版车正转系数583312
  fp64  Gyro_Convert2=1.5818358893;    //第二版车反转系数
  fp64  Gyro_Convert= (1.5816213855+1.5818358893)/2;
