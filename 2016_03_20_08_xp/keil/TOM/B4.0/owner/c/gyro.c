...
#ifdef	FIRST
fp64  Gyro_Convert1=1.5733821965;    //????????
fp64  Gyro_Convert2=1.5733669666;    //????????
...
{
	Gyro_Convert1=720*10000000.0/(fp64)Gyro_Total_NoFloat;
	//Gyro_Convert1=3600*1000000.0/(fp64)Gyro_Total_NoFloat;
}
void Gyro_Init_N(void)
{
	Gyro_Convert2=-720*10000000.0/(fp64)Gyro_Total_NoFloat;
