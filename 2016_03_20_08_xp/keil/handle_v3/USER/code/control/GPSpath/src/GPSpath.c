...
void gps_path_update()
{
	...
	PRO = (unsigned char )gps.speed * 3.0 / 1000.0; 
	//get error
	#ifdef LEFT 
...
// 	distance_error = (camera.offset-40)*600/80;
...
// 		if(gps.front_point.y > 8100 && gps.speed > 1000)
// 		{
// 			TIM4->CCR3 = 0x705;
// 		}
// 		else 
