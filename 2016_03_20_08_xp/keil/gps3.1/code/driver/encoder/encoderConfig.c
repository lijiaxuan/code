#ifndef ENCODERCONFIG_C
#define ENCODERCONFIG_C

#include "encoder.h"

uint16_t CPR;
int16_t r_now[2];
TIM_TypeDef* Tim_S[2]={TIM3,TIM2};
...
void QEI_Init(void)
{
	...
	//TIM3
	{
		...
		TIM_TimeBaseStructure.TIM_Period = Encoders_par[0].count_per_rotation-1; 			
...
// 		TIM_TimeBaseStructInit(&TIM_TimeBaseStructure);
// 		TIM_TimeBaseStructure.TIM_Prescaler = 0x0; 
// 		TIM_TimeBaseStructure.TIM_Period = Encoders_par[0].count_per_rotation-1;-1; 			
// 		TIM_TimeBaseStructure.TIM_ClockDivision = TIM_CKD_DIV1; 
// 		TIM_TimeBaseStructure.TIM_CounterMode = TIM_CounterMode_Up;
