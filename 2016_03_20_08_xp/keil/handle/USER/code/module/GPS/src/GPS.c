...
* @Last Modified time: 2016-01-18 21:32:28
*/
#include "../inc/GPS.h"
...
{
	//count_per_rotation  R 		carwidth 		TIMx     direction   			convert
	{	2048,					0,		247.65,				TIM3,		-1,			3925/47287.0},
	{   2048,					0,		247.65,				TIM8,		1,			3925/38799.0}
...
{
	3600*10000000.0/(float)(22698922869+22811702586)*2,		//gyro_convert1
	3600*10000000.0/(float)(22698922869+22811702586)*2,		//gyro_convert2
	{
		0,		//value
		0		//count
	},
...
void GPS_init()
{
	...
	UART1_DMA_EN();
	Gyro_CheckFloat();
	gps.point.y = 700;// 6200;
	gps.point.x = 0;// 2641.2;
}
