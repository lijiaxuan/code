...
* @Last Modified time: 2016-03-19 10:28:24
*/
...
// 	unsigned short		delta_index 	= 0;
	...
	//pre_point = (722.0 * gpspath.pre / 1000.0); 
	//get error
	//#ifdef LEFT 
	...
	if(gps.front_point.y > 7350 && camera.offset != 0)
	{
...
void timer_cfg(void)
{
	...
	TIM_TimeBaseStructure.TIM_Period = 5000; // 5000 - 5ms
